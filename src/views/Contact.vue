...
<template>
    ...
    <div class="relative w-full h-1/2-screen lg:h-screen"> 
      ...
      <Transition name="appear-slide" appear>
        <h1 class="absolute top-1/2 left-2 lg:top-60 lg:left-80 text-white text-5xl lg:text-8xl">CONTACT</h1>
      </Transition>
    </div>
    <div class="max-w-full p-2 lg:px-80 lg:py-10 bg-teal-50 z-10 ">
      <h1 class="">
        ...
        Interdum et malesuada fames ac ante ipsum primis in faucibus. Integer ac mollis sapien, a feugiat dolor. Sed quis iaculis lorem, vel rhoncus ipsum. Aenean imperdiet pretium sapien, nec maximus diam luctus condimentum. Ut est nulla, mollis in interdum ut, congue a nulla. Duis a leo odio. Morbi vitae purus sit amet dolor venenatis tincidunt non at lorem. Donec egestas fringilla nunc, ornare condimentum diam iaculis non. Praesent maximus mi enim, non cursus ex auctor a. In nec vehicula ante, quis semper mi.

        Ut in tincidunt libero. Sed sit amet sem lorem. Phasellus at leo vel nulla accumsan mollis. Phasellus eleifend lobortis dolor vel feugiat. Nulla fermentum risus at risus fermentum, at aliquam felis commodo. Nam mollis, ante sit amet mattis porttitor, ex urna maximus felis, vel lobortis massa orci et mauris. Donec pulvinar suscipit suscipit. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Praesent at augue eu dolor viverra maximus. Fusce malesuada nibh sed venenatis mollis. In finibus libero ac tellus mattis, ut aliquam massa suscipit. In vel nisi eu tortor pellentesque scelerisque nec nec velit. Praesent diam felis, iaculis a blandit sed, lacinia at metus.
